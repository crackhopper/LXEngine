...
if(_lx_existing_env_ready)
  ...
  lx_windows_msvc_finalize_compiler()
  return()
endif()

lx_windows_msvc_find_install(_lx_vs_root _lx_bootstrap_script _lx_bootstrap_kind)
lx_windows_msvc_import_env("${_lx_vs_root}" "${_lx_bootstrap_script}" "${_lx_bootstrap_kind}")
lx_windows_msvc_finalize_compiler()
