...
[`REQ-042`](../../../../requirements/042-a-frame-graph-v1-resource-target-pass-execution.md) R7 把
...
- **新增隐式角色：image-as-attachment**。当前 `IGpuResource` 的实现集中于
  ...
  `SkeletonData`）和 texture 类（`CombinedTextureSampler`）。REQ-042 让
