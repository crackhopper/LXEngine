...
- `REQ-076-b`: realtime material path hard cut and smoke，保证 texture/default texture 进入 clean realtime 默认路径。
- `REQ-076-d`: OfflineRT config hard cut，保证后续 texture/package 工作面对同一套 clean SceneResourceTable / RenderPathGraph 默认路径。
