...
2026-06-14 复核通过。073-c 已完成 material source shader variant、final shader reflection、RenderPathNode pipeline identity、Helmet conversion/smoke 和 diagnostics 边界；URI hard cut、indirect batching、realtime fallback 删除和 OfflineRT graph path 已拆给后续需求。
