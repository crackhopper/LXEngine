...
2026-06-14 复核关闭：PBR/IBL shader 消费路径已完成并仍被当前 Forward/Deferred shader 使用。旧 PBR material-local 合同已被后续 Material v2/v3 source contract 取代；后续材质事实以 `REQ-073-*` 为准。
