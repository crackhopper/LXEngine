...
> 2026-06-14 归档：RenderPathGraph、RenderPassNode、RenderFeature 与 FrameGraph contract 已经成为当前代码基础；剩余 Material v3 hard cut、OfflineRT graph path、legacy bridge 删除和非 mesh 渲染扩展分别由 `REQ-073-*` / `REQ-073-j`、`REQ-074-h/i`、`REQ-076-c` 承接。
