...
LX 启示：[REQ-042](../../../requirements/finished/042-a-frame-graph-v1-resource-target-pass-execution.md) 的 RenderTarget 拆分后，binding 端可以直接用 dynamic rendering 实现，省掉 framebuffer 对象池。
