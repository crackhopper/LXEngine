...
| 3DGS PLY Rendering | [3dgs-ply-rendering/README.md](3dgs-ply-rendering/README.md) | 3D Gaussian Splatting PLY 支持调研：字段约定、assets-downloader cache 样例、Gaussian 投影、透明排序 / alpha 合成、LX 当前 scene / loader / Vulkan 边界对照，以及 `REQ-077-a` 到 `REQ-077-e` 的后置演进路径 | 2026-05-28 |
