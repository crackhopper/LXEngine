...
- LX REQ-042 草稿：[`notes/requirements/finished/042-a-frame-graph-v1-resource-target-pass-execution.md`](../../../requirements/finished/042-a-frame-graph-v1-resource-target-pass-execution.md)
