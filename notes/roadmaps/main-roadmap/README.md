...
| [Phase 1.5](phase-1.5-imgui-editor-mvp.md) ImGui Editor MVP + 命令总线 | 部分开工，REQ-035 / REQ-036 / REQ-037-a / REQ-037-b / REQ-038-a 已完成，后续从 REQ-041-a 继续 | `Transform` 值类型 / scene path lookup / component model foundation / camera component migration / ray-AABB picking | **v1**：[REQ-035](../../requirements/finished/035-transform-component.md) Transform / [REQ-036](../../requirements/finished/036-scene-node-path-lookup.md) 路径查询 / [REQ-037-a](../../requirements/finished/037-a-component-model-foundation.md) IComponent 基础 + Mesh/Material/Skeleton 转 component / [REQ-037-b](../../requirements/finished/037-b-camera-as-component.md) Camera 作为 component / [REQ-038-a](../../requirements/finished/038-a-ray-aabb-picking-min.md) ray-AABB picking / [REQ-039-a](../../requirements/finished/039-a-debug-draw-subsystem.md) DebugDraw / [REQ-040-a](../../requirements/finished/040-a-editor-command-bus.md) 命令总线 / [REQ-041-a](../../requirements/finished/041-a-imgui-editor-mvp.md) ImGui Editor MVP；MCP shim 推到 Phase 1.6。**当前 active scene authoring（041-*）**：[REQ-041-d](../../requirements/041-d-scene-authoring-toolbar-palette.md) 工具栏拖拽创建 / [REQ-041-e](../../requirements/041-e-scene-authoring-inspector-material-and-visibility.md) Inspector 材质与可见性 / [REQ-041-f](../../requirements/041-f-scene-authoring-node-rename-duplicate.md) Rename·Duplicate |
