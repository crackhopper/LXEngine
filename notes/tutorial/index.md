...
| 4 | [Offline Renderer](offline-renderer/index.md) | 用同一份 scene 跑 headless Vulkan compute，并理解 path tracing 扩展点 |
| 5 | [自定义材质](custom-material/index.md) | 理解材质系统，并写一个 Gooch shader |
| 6 | [自定义灯光](custom-light/index.md) | 理解当前 light 底座和未来 custom light 工作流 |
| 7 | [扩展编辑器](extend-editor/index.md) | 理解 toolbar 与 command bus 如何配合 |
