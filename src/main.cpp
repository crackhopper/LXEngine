...
// using Vertex = LX_graphics::Vertex;
...
//     LX_graphics::QueryQueueFamilyResult queueFamilyIndices = findQueueFamilies(physicalDevice);
...
//     std::vector<LX_graphics::DeviceScore> scoredDevices;
...
//                          [](const LX_graphics::DeviceScore &a, const LX_graphics::DeviceScore &b) {
...
//     LX_graphics::SwapChainSupportDetails swapChainSupport = querySwapChainSupport(device);
...
//   LX_graphics::QueryQueueFamilyResult findQueueFamilies(VkPhysicalDevice physicalDevice) {
//     LX_graphics::QueryQueueFamilyResult indices;
