...
std::vector<LX_core::ShaderResourceBinding> deferredLightingBindings() {
  return {
      ...
      LX_core::ShaderResourceBinding{
          ...
          {LX_core::StructMemberInfo{"direction",
           ...
           LX_core::StructMemberInfo{"color", LX_core::ShaderPropertyType::Vec4,
                                     16, 16}}},
      LX_core::ShaderResourceBinding{"IrradianceMap",
                                     3,
                                     0,
                                     ...
                                     LX_core::ShaderStage::Fragment,
                                     {}},
      LX_core::ShaderResourceBinding{"PrefilteredEnvMap",
                                     3,
                                     1,
                                     LX_core::ShaderPropertyType::TextureCube,
                                     1,
                                     ...
                                     LX_core::ShaderStage::Fragment,
                                     {}},
      LX_core::ShaderResourceBinding{"BrdfLut",
                                     3,
                                     2,
                                     LX_core::ShaderPropertyType::Texture2D,
                                     1,
      ...
      LX_core::ShaderResourceBinding{
          ...
          LX_core::ShaderPropertyType::UniformBuffer,
          1,
          sizeof(LX_core::ToneMappingData::Param),
          0,
          LX_core::ShaderStage::Fragment,
      ...
      LX_core::ShaderResourceBinding{
          ...
          LX_core::ShaderPropertyType::UniformBuffer,
          1,
          sizeof(LX_core::SurfaceLightingData::Param),
          0,
          LX_core::ShaderStage::Fragment,
          {LX_core::StructMemberInfo{"enableIblLighting",
                                     LX_core::ShaderPropertyType::Int, 0, 4},
           ...
           LX_core::StructMemberInfo{"environmentIblReady",
                                     LX_core::ShaderPropertyType::Int, 12, 4},
