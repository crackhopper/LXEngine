...
The project SHALL define an explicit manual acceptance checklist for `lxe_editor` covering the maintained user-facing behaviors required for requirement closure.

#### Scenario: checklist enumerates observable demo behavior
- **WHEN** a developer prepares to manually validate `lxe_editor`
